...
namespace RotaCar_Rental.Areas.Customer.Controllers
{
	...
	public class HomeController : Controller
	{
		...
		[HttpGet]
		public JsonResult SearchLocations(string searchTerm)
		{

			var locationName = _unit.location.GetAll(a => a.Name.Contains(searchTerm)).Select(a => new {a.Id,a.Name,a.City } ).ToList();
